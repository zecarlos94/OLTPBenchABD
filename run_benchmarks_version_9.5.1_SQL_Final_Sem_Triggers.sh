...
do
  ...
  # Drop Materialized Views, Indexes from remove_queries_no_triggers.sql script
  cd Databases/
  psql -h localhost -e epinions -f remove_queries_no_triggers.sql
  cd ..
  ...
  # Create Views+Indexes after loading all data
  cd Databases/
  psql -h localhost -d epinions -f views.sql
  cd ..
