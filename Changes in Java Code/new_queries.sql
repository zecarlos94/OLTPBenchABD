...
CLUSTER reviews_average_rating_clustered USING IDX_RATING_IID;
...
create materialized view GetItemReviewsByTrustedUser as
	select r.a_id,r.u_id,r.i_id,r.rating,t.source_u_id,t.target_u_id,t.trust,t.creation_date from review as r
		inner join trust as t
...
create materialized view GetReviewItemById as
        select r.a_id,r.u_id,r.i_id,r.rating,i.title from review as r
...
create materialized view GetReviewsByUser as
        select r.a_id,r.u_id,r.i_id,r.rating,u.name from review as r
...
CLUSTER items_update_title_clustered USING IDX_TITLE_IID;
...
CLUSTER reviews_update_rating_clustered USING IDX_RATING_IID_UID;
...
CLUSTER reviews_update_trust_clustered USING IDX_RATING_SUID_TUID;
...
CLUSTER user_update_name_clustered USING IDX_NAME_UID;
