...
CLUSTER TABLE reviews_average_rating_clustered USING INDEX IDX_RATING_IID;
...
CLUSTER TABLE items_update_title_clustered USING INDEX IDX_TITLE_IID;
...
CLUSTER TABLE reviews_update_rating_clustered USING INDEX IDX_RATING_IID_UID;
...
CLUSTER TABLE reviews_update_trust_clustered USING INDEX IDX_RATING_SUID_TUID;
...
CLUSTER TABLE user_update_name_clustered USING INDEX IDX_NAME_UID;
