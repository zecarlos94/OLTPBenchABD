...
DROP TRIGGER trig_01_refresh_GetAverageRatingByTrustedUser ON review;
DROP TRIGGER trig_02_refresh_GetAverageRatingByTrustedUser ON trust;
DROP TRIGGER trig_01_refresh_GetItemReviewsByTrustedUser ON review;
DROP TRIGGER trig_02_refresh_GetItemReviewsByTrustedUser ON trust;
DROP TRIGGER trig_01_refresh_GetReviewItemById ON review;
DROP TRIGGER trig_02_refresh_GetReviewItemById ON item;
DROP TRIGGER trig_01_refresh_GetReviewsByUser ON review;
DROP TRIGGER trig_02_refresh_GetReviewsByUser ON "user";
