...
CREATE UNIQUE INDEX IDX_MVIEW_GARBTU ON GetAverageRatingByTrustedUser (i_id);
...
CREATE UNIQUE INDEX IDX_MVIEW_GIRBTU ON GetItemReviewsByTrustedUser (i_id);
...
CREATE UNIQUE INDEX IDX_MVIEW_GRIBI ON GetReviewItemById (i_id);
...
CREATE UNIQUE INDEX IDX_MVIEW_GRBU ON GetReviewsByUser (u_id);
